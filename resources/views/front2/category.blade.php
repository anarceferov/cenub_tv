            ...
            <div class="row my-5">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="img-area-category">
                        <a href="{{route('news.inner',$new->slug)}}"><img src="{{asset($new->image)}}"
                                alt="{{$new->slug}}" class="w-100" /></a>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="grid-category">
                        @foreach($new->tag as $tag)
                        <a href=""><span class="tags travel" style="background:{{$tag->color}}">{{$tag->name}}</span>
                        </a>
                        @endforeach
                    </div>
                    <div class="img-text-category">
                        ...
                        <ul class="post-meta-info d-flex text-dark ">
                            <li class="author">
                                ...
                                <a href="" class="text-dark"> {{$new->tarix}} </a>
                            </li>
                        </ul>
                    </div>
                    <p>
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="row px-2 my-5 side-banner">
                <div class="col-lg-12 d-xl-block d-lg-block d-md-none d-none">
                    <div class="discount">
                        <a href="#"><img src="{{asset('front/img/sidebar_banner.png')}}" class="w-100" alt="" /></a>
                    </div>
                </div>
            </div>
            <div class="row my-3">
                    ...
                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="recent-tab" data-toggle="tab" href="#recent" role="tab"
                                aria-controls="recent" aria-selected="true">Ən son xəbərlər</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="popular-tab" data-toggle="tab" href="#popular" role="tab"
                                aria-controls="popular" aria-selected="false">Məşhur xəbərlər</a>
                        </li>
                    </ul>
            ...
            <div class="row my-3">
                <div class="col-xl-12">
                    ...
                    <div class="tag-container">
                        @foreach($tags as $tag)
                        <a href="{{route('tag' , $tag->news_id)}}"
                            style="background: {{$tag->color}};color: #fff">{{$tag->name}}</a>
                        @endforeach
                    </div>
                </div>
            </div>
